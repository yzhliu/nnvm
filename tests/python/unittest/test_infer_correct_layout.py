...
# Level 1
def infer_correct_layout(g, layout=None):
...
def test_matmul():
    ...
    g, ldict = infer_correct_layout(c, {"a" : "HW", "b" : "WC"})
    assert(ldict["a"][0] == "HW")
    assert(ldict["b"][0] == "WC")
    assert(ldict["matmul"][0] == "HC")
    # second pass will insert layout transform
    _, ldict = infer_correct_layout(g, {"a" : "HW16w", "b" : "WC16c"})
    ...
    g, ldict = infer_correct_layout(c, {"a" : "HW", "b" : "CH"})
    assert(ldict["a"][0] == "HW")
    assert(ldict["b"][0] == "CH")
    assert(ldict["matmul"][0] == "WC")
...
def test_concatenate():
    ...
    g, ldict = infer_correct_layout(z, {"x":"HW", "y":"HW"})
    assert(ldict["x"][0] == "HW")
    assert(ldict["y"][0] == "HW")
    assert(ldict["concat"][0] == "__undef__")
    # second pass will insert layout transform
    _, ldict = infer_correct_layout(g, {"x":"HW16w", "y":"HW16w"})
...
def test_batchnorm():
    ...
    g, ldict = infer_correct_layout(y, "NCHW")
    ...
    g, ldict = infer_correct_layout(g, "NCH16cW")
...
def test_flatten():
    ...
    assert(ldict["y"][0] == "__undef__")
    # second pass will insert layout transform
    _, ldict = infer_correct_layout(g, "NCHW16c")
...
def test_conv2d():
    ...
    _, ldict = infer_correct_layout(y)
    assert(ldict["data"][0] == "NCHW")
...
def test_reshape():
    ...
    g, ldict = infer_correct_layout(y, "C")
    assert(ldict["x"][0] == "C")
    assert(ldict["y"][0] == "__undef__")
    # second pass will insert layout transform
    g, ldict = infer_correct_layout(g, "C16c")
...
def test_broadcast_to():
    ...
    assert(ldict["y"][0] == "__undef__")
    # second pass will insert layout transform
    g, ldict = infer_correct_layout(g, "HW16h")
